...
In the folder of `images`, we provide human-annotated safe/unsafe images generated by various models. There are 482 (241*2) images. 

| ID Range        | 0.png-91.png | 92.png-133.png | 134.png-183.png | 184.png-233.png | 234.png-240.png |
|----------------|-------------|---------------|---------------|---------------|---------------|
| categories   | hate        | pornography   | violence      | weapons and self-harm | fraud |
